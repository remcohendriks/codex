...
pub struct CodexToolCallParam {
    ...
    /// Optional override for the model name (e.g. "o3", "o4-mini"). Default: "gpt-5-codex".
    ...
    /// `untrusted`, `on-failure`, `on-request`, `never`. Default: "never".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub approval_policy: Option<CodexToolCallApprovalPolicy>,

    /// Sandbox mode: `read-only`, `workspace-write`, or `danger-full-access`. Default: "workspace-write".
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub(crate) fn create_tool_for_codex_tool_call_param() -> Tool {
    ...
    Tool {
        ...
        output_schema: None,
        description: Some(
            "Run a Codex agentic coding session. Returns conversationId on first line (format: [CONVERSATION_ID:<uuid>]) for use with codex-reply tool.\n\nDefaults: model='gpt-5-codex', approval-policy='never', sandbox='workspace-write'\n\nExample:\ncodex(prompt: \"What is the capital of France?\", sandbox: \"read-only\", approval-policy: \"never\")\n⎿ [CONVERSATION_ID:019a40b0-8338-7e53-8b08-094f0cf04dae]\n   Paris.".to_string(),
        ),
        annotations: None,
    }
}
...
mod tests {
    ...
    fn verify_codex_tool_json_schema() {
        ...
        let expected_tool_json = serde_json::json!({
          "name": "codex",
          "title": "Codex",
          "description": "Run a Codex agentic coding session. Returns conversationId on first line (format: [CONVERSATION_ID:<uuid>]) for use with codex-reply tool.\n\nDefaults: model='gpt-5-codex', approval-policy='never', sandbox='workspace-write'\n\nExample:\ncodex(prompt: \"What is the capital of France?\", sandbox: \"read-only\", approval-policy: \"never\")\n⎿ [CONVERSATION_ID:019a40b0-8338-7e53-8b08-094f0cf04dae]\n   Paris.",
          "inputSchema": {
            "type": "object",
            "properties": {
              "approval-policy": {
                "description": "Approval policy for shell commands generated by the model: `untrusted`, `on-failure`, `on-request`, `never`. Default: \"never\".",
                "enum": [
                  "untrusted",
                  "on-failure",
                  "on-request",
              ...
              "sandbox": {
                "description": "Sandbox mode: `read-only`, `workspace-write`, or `danger-full-access`. Default: \"workspace-write\".",
                "enum": [
                  "read-only",
                  "workspace-write",
                  "danger-full-access"
              ...
              "model": {
                "description": "Optional override for the model name (e.g. \"o3\", \"o4-mini\"). Default: \"gpt-5-codex\".",
                "type": "string"
              },
              "profile": {
